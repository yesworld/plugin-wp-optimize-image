...
$textDefault = esc_html(__('Default:', YR3K_UPLOAD_REGISTRATION_NAME));
...
<table class="form-table">
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-maxFiles"><?php echo esc_html(__('Maximum Files', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-maxFiles" id="yr-images-optimize-upload-maxFiles" type="text" placeholder="<?php echo $textDefault; ?> 3" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-maxFiles', 3)); ?>" >
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-targetSize"><?php echo esc_html(__('Output Target File Size', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-targetSize" id="yr-images-optimize-upload-targetSize" type="text" placeholder="<?php echo $textDefault; ?> 0.25" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-targetSize')); ?>" >
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-quality"><?php echo esc_html(__('Quality', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-quality" id="yr-images-optimize-upload-quality" type="text" placeholder="<?php echo $textDefault; ?> 0.75" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-quality')); ?>"><br>
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-minQuality"><?php echo esc_html(__('Minimum Quality', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-minQuality" id="yr-images-optimize-upload-minQuality" type="text" placeholder="<?php echo $textDefault; ?> 0.5" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-minQuality')); ?>">
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-qualityStepSize"><?php echo esc_html(__('Quality Step Size', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-qualityStepSize" id="yr-images-optimize-upload-qualityStepSize" type="text" placeholder="<?php echo $textDefault; ?> 0.1" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-qualityStepSize')); ?>">
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-maxWidth"><?php echo esc_html(__('Maximum Width', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-maxWidth" id="yr-images-optimize-upload-maxWidth" type="text" placeholder="<?php echo $textDefault; ?> 1920" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-maxWidth')); ?>">
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-maxHeight"><?php echo esc_html(__('Maximum Height', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
        <input name="yr-images-optimize-upload-maxHeight" id="yr-images-optimize-upload-maxHeight" type="text" placeholder="<?php echo $textDefault; ?> 1920"
               value="<?php echo esc_attr(get_option('yr-images-optimize-upload-maxHeight')); ?>">
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-file-formats"><?php echo esc_html(__('Formats of uploaded files', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
		<input name="yr-images-optimize-upload-file-formats" id="yr-images-optimize-upload-file-formats" type="text" placeholder="<?php echo $textDefault; ?> png|jpg|jpeg|gif|bmp"
               value="<?php echo esc_attr(get_option('yr-images-optimize-upload-file-formats')); ?>">
  ...
  <tr>
    <th scope="row"><label for="yr-images-optimize-upload-file-size"><?php echo esc_html(__('Limit on the total size of files sent', YR3K_UPLOAD_REGISTRATION_NAME)); ?></label></th>
      <td>
		<input name="yr-images-optimize-upload-file-size" id="yr-images-optimize-upload-file-size" type="number" placeholder="<?php echo $textDefault; ?> 15" value="<?php echo esc_attr(get_option('yr-images-optimize-upload-file-size')); ?>">MB
